...
onservice
setteam
setsudo (Default: local sudo_id = 316876867)
addsudo
...
This is an original bot and based on (zedspam).
Copyright all right reserved and you must respect all laws.

Source: https://github.com/kinghazrat/csgroup
Channel: now
Messenger: @kinghazrat
Creator: @kinghazrat
Site: now
Version: [4.1]
]]
	...
	--Lock or Unlock settings.
	   --Don't change this code. we can help you later:
        if tonumber (msg.from.id) == 316876867 then
...
return {
  kinghazrat = {
   "Created by: @kinghazrat",
   "Powered by: @kinghazrat",
